...
Only [QB's 2000 chips]({{< relref "/chips/gallery/2000-qb" >}}) were actually available at BARGE in 2000.

The [2001]({{< relref "/chips/gallery/2001" >}}) chips were produced at the same time, so the [2001 development
notes]({{< relref "/chips/gallery/2001#development-notes" >}}) discussion of changes to the chip vendor
