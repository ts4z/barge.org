...
* Try to sign up for as many &ldquo;unofficial&rdquo; BARGE events as possible.
  ...
  etc ).  These events ideas show up on the [BARGE Email List]({{< relref "/resources/mailing-lists" >}})
...
* Get a copy of the BARGE-At-A-Glance (BAAG) schedule of events.  This can be
  ...
  List]({{< relref "/resources/mailing-lists" >}}), at [www.barge.org]({{< relref "/" >}}) and sometimes you can find a
...
* Sign up for and post any and all BARGE related questions on the [BARGE Email
  List]({{< relref "/resources/mailing-lists" >}}) at barge@barge.org.  Many of the members will be glad
